...
print("新規メモリ領域獲得前。Enterキーを押すと100MiBの新規メモリ領域を獲得します： ")
input()
  
# mmap()システムコールの呼び出しによって100MiBの新規メモリ領域を獲得
memregion = mmap.mmap(-1, ALLOC_SIZE, flags=mmap.MAP_PRIVATE)
show_message("新規メモリ領域を獲得しました。Enterキーを押すと1秒に10MB\
  づつ、合計100MiBの新規メモリ領域にアクセスします： ")
input()
